...
Lengte = prompt("Wat is jouw lengtein cm? ");
while (!Number(Lengte)) {
  console.log("Het moet een cijfer zijn in cm!");
  Lengte = prompt("Wat is jouw lengte in cm? ");
}

console.log("Mijn naam is: " + Naam);
console.log("Mijn leeftijd is: " + Leeftijd);
console.log("Jouw Gender is: " + Gender);
console.log("Wat is jouw lengte in cm? " + Lengte);
